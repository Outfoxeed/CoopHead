...
namespace OutFoxeed.TransformInspector.Editor
{
    public static class CopyPasteManager
    {
        ...
        {
            return OutFoxeed.Editor.FileReader.GetFilePath("TransformData");
        }


        public static TransformData GetTransformData() 
            => OutFoxeed.Editor.FileReader.GetDataFromJson<TransformData>(GetTransformDataPath());
        public static void StoreTransformData(TransformData data)
            => OutFoxeed.Editor.FileReader.StoreDataOnJson(data, GetTransformDataPath());
